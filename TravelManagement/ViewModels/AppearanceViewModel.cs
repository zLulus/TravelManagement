...
namespace ModernUINavigation.Pages.Settings
{
    ...
    public class AppearanceViewModel
        : ViewModelBase<AppearanceViewModel>
    {
        #region  fields
        ...
        public Link SelectedTheme
        {
            ...
            set
            {
                if (this.selectedTheme != value)
                {
                    ...
                    NotifyPropertyChanged(m => m.SelectedTheme);
        ...
        public string SelectedFontSize
        {
            ...
            set
            {
                if (this.selectedFontSize != value)
                {
                    ...
                    NotifyPropertyChanged(m => m.selectedFontSize);
        ...
        public Color SelectedAccentColor
        {
            ...
            set
            {
                if (this.selectedAccentColor != value)
                {
                    ...
                    NotifyPropertyChanged(m => m.selectedAccentColor);
